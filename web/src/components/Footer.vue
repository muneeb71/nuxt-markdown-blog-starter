<template>
  ...
  <footer class="bg-white" style="background-color: black;">
    <div
    ...
    >
      ...
      <div class="mt-8 md:mt-0 md:order-1">
        <p class="text-center md:text-left text-base text-gray-400">
          &copy; 2022 Created by Muneeb Ahmed for
          <a class="hover:underline" href="https://metaversedogcrypto.com"
            >MVDG</a
          >
        </p>
        <p class="text-center md:text-left text-base text-gray-400">
