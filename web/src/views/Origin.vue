<template>
  <div class="text-center pt-12">
    <h1 class="text-2xl font-bold mb-8">
      Bridge from ETH (Goerli) to Polygon (Mumbai)
    </h1>

    <p>
      This bridge allows you to send MetaverseDog (MVD) from Ethereum
      Goerli testnet to Polygon Mumbai network
    </p>
    ...
    <form class="w-96 mt-8 mx-auto">
      ...
      <div class="mt-4 w-2/3 mx-auto relative rounded-md shadow-sm">
        ...
        <input
          ...
          name="price"
          id="price"
          class="focus:ring-gray-500 text-gray-500 focus:border-yellow-500 block w-full pl-7 pr-12 sm:text-sm border-gray-300 rounded-md"
          placeholder="0.00"
