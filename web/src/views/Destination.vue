<template>
  <div class="text-center pt-12">
    <h1 class="text-2xl font-bold mb-8">
      Bridge from Polygon (Mumbai) to ETH (Goerli)
    </h1>

    <p>
      This bridge allows you to send MetaverseDog (MVD) from Polygon Testnet back to ETH Goerli
    </p>
    ...
    <form class="w-96 mt-8 mx-auto">
      <label for="price" class="block mb-2 font-medium text-white-700"
        >How much MVD do you want to bridge?</label
      >
      <div class="mt-4 w-2/3 mx-auto relative rounded-md shadow-sm">
        ...
        <input
          ...
          name="price"
          id="price"
          class="focus:ring-indigo-500 text-gray-500 focus:border-indigo-500 block w-full pl-7 pr-12 sm:text-sm border-gray-300 rounded-md"
          placeholder="0.00"
      ...
      <button
        type="button"
        class="inline-flex items-center px-4 py-2 mt-4 border border-transparent shadow-sm text-base font-medium rounded-md text-white bg-yellow-500 hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
        @click="sendTokens"
      >
        <svg
...
import DChainstackDollars from '../artifacts/contracts/DestinationToken.sol/MetaverseDogPoly.json'
import ChainstackDollars from '../artifacts/contracts/OriginToken.sol/MetaverseDogEth.json'
