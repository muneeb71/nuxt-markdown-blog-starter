...
contract MetaverseDogPoly is ERC20, ERC20Burnable {
    address bridge;

    constructor(address _bridge) ERC20("MetaverseDog", "MVD") {
        bridge = _bridge;
    }
    ...
    modifier onlyBridge() {
        require(
            bridge == msg.sender,
            "MetaverseDog: only the bridge can trigger this method!"
        );
        _;
    }
